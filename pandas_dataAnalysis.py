...
product_performance = (
    sales_data.groupby("Product")[["Quantity Ordered", "Sales"]].sum().reset_index()
)
product_performance["Average Price"] = (
    product_performance["Sales"] / product_performance["Quantity Ordered"]
)
